const workList = {
  vietnamese: [
    ...
    },
    {
      ...
      company: 'CÔNG TY EVOLABLE ASIA',
      period: '08/2016 - 04/2020',
      description: `Nhận yêu cầu từ phía hàng bên Nhật.<br />
                    Trao đổi thông tin khi cần thiết.<br />
                    Tạo các file bảng giá theo yêu cầu, sau đó bỏ vào hệ thống.<br />
                    Tham gia các buổi họp cải tiến nghiệp vụ.`,
  ...
  english: [
    ...
    {
      job: 'Data Processing Staff',
      company: 'EVOLABLE ASIA',
      period: '08/2016 - 04/2020',
      description: `Receive requests from Japanese client.<br />
                    Exchange to get more than clearly understand those of requests.<br />
                    Base on requests, create price table by excel. After then, import that file excel in system.<br />
                    Join meetings which how to make work better.`,
      icon: 'far fa-building',
    },
  ]
}
